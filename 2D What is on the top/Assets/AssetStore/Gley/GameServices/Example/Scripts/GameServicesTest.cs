...
namespace Gley.GameServices.Internal
{
    public class GameServicesTest : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            else
            {
                ...
                if (allLeaderboards.Length > 0)
                {
                    ...
                    if (Button("Submit HeightTracker"))
                    {
                        Debug.Log("Submit HeightTracker: " + score + " to leaderboard " + allLeaderboards[indexNumberLeaderboards]);
                        //submit a score
                        //it also can be done like this:
        ...
        private void ScoreSubmitted(bool success, GameServicesError error)
        {
            ...
            {
                //an error occurred
                Debug.LogError("HeightTracker failed to submit: " + error);
            }
